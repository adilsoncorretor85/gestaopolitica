// Script para importar dados usando a chave de serviço do Supabase local
...
// Configurações do Supabase local (com chave de serviço)
...
async function importWithServiceKey() {
  console.log('🚀 Iniciando importação com chave de serviço...');
