...
COMMENT ON TYPE "public"."gender_type" IS 'Tipo para sexo: M (Masculino), F (Feminino), O (Outro)';
...
CREATE OR REPLACE FUNCTION "public"."app_delegate_people"("from_leader" "uuid", "to_leader" "uuid", "opts" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
...
ALTER FUNCTION "public"."app_delegate_people"("from_leader" "uuid", "to_leader" "uuid", "opts" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."app_remove_leader"("p_leader_id" "uuid", "p_mode" "text", "p_target_leader_id" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'auth'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."app_remove_leader"("p_leader_id" "uuid", "p_mode" "text", "p_target_leader_id" "uuid") OWNER TO "postgres";
...
ALTER TABLE "public"."gcal_accounts" OWNER TO "postgres";
...
ALTER TABLE "public"."gcal_events" OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."people"."treatment" IS 'Tratamento/pronome de tratamento (ex: Dr., Prof., Sr.)';



COMMENT ON COLUMN "public"."people"."gender" IS 'Sexo: M (Masculino), F (Feminino), O (Outro)';
...
ALTER TABLE ONLY "public"."gcal_accounts"
    ADD CONSTRAINT "gcal_accounts_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."gcal_events"
...
CREATE UNIQUE INDEX "gcal_events_google_id_idx" ON "public"."gcal_events" USING "btree" ("google_event_id");



CREATE UNIQUE INDEX "gcal_singleton" ON "public"."gcal_accounts" USING "btree" ((true));



CREATE INDEX "idx_people_birth_date" ON "public"."people" USING "btree" ("birth_date") WHERE ("birth_date" IS NOT NULL);



CREATE INDEX "idx_people_owner_birth_date" ON "public"."people" USING "btree" ("owner_id", "birth_date") WHERE ("birth_date" IS NOT NULL);
...
CREATE INDEX "idx_people_treatment" ON "public"."people" USING "btree" ("treatment");
...
CREATE OR REPLACE TRIGGER "Atualizar banco de dados" AFTER INSERT ON "public"."people" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://n8n.adilson-martins-jlle.workers.dev/', 'POST', '{"Content-type":"application/json"}', '{}', '5000');
...
CREATE OR REPLACE TRIGGER "trg_gcal_accounts_touch" BEFORE UPDATE ON "public"."gcal_accounts" FOR EACH ROW EXECUTE FUNCTION "public"."touch_updated_at"();



CREATE OR REPLACE TRIGGER "trg_gcal_events_touch" BEFORE UPDATE ON "public"."gcal_events" FOR EACH ROW EXECUTE FUNCTION "public"."touch_updated_at"();
...
ALTER TABLE ONLY "public"."gcal_accounts"
    ADD CONSTRAINT "gcal_accounts_owner_profile_id_fkey" FOREIGN KEY ("owner_profile_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
CREATE POLICY "gcal_accounts_admin_write" ON "public"."gcal_accounts" TO "authenticated" USING ("public"."app_is_admin"("auth"."uid"())) WITH CHECK ("public"."app_is_admin"("auth"."uid"()));



CREATE POLICY "gcal_accounts_select_admin" ON "public"."gcal_accounts" FOR SELECT TO "authenticated" USING ("public"."app_is_admin"("auth"."uid"()));
...
CREATE POLICY "gcal_events_admin_write" ON "public"."gcal_events" TO "authenticated" USING ("public"."app_is_admin"("auth"."uid"())) WITH CHECK ("public"."app_is_admin"("auth"."uid"()));



CREATE POLICY "gcal_events_read_leader_or_admin" ON "public"."gcal_events" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles" "p"
...
GRANT ALL ON FUNCTION "public"."app_delegate_people"("from_leader" "uuid", "to_leader" "uuid", "opts" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."app_delegate_people"("from_leader" "uuid", "to_leader" "uuid", "opts" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."app_delegate_people"("from_leader" "uuid", "to_leader" "uuid", "opts" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."app_remove_leader"("p_leader_id" "uuid", "p_mode" "text", "p_target_leader_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."app_remove_leader"("p_leader_id" "uuid", "p_mode" "text", "p_target_leader_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."app_remove_leader"("p_leader_id" "uuid", "p_mode" "text", "p_target_leader_id" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."gcal_accounts" TO "anon";
GRANT ALL ON TABLE "public"."gcal_accounts" TO "authenticated";
GRANT ALL ON TABLE "public"."gcal_accounts" TO "service_role";



GRANT ALL ON TABLE "public"."gcal_events" TO "anon";
GRANT ALL ON TABLE "public"."gcal_events" TO "authenticated";
GRANT ALL ON TABLE "public"."gcal_events" TO "service_role";
