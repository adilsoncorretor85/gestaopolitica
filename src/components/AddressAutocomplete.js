...
export default function AddressAutocomplete({ label = 'Endereço', placeholder = 'Digite o endereço...', defaultValue = '', onSelect, className = '' }) {
