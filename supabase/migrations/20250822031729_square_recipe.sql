/*
  ...
  1. New Tables
    - `leader_profiles` - Extended profile data for leaders (1:1 with profiles)
    - `invite_tokens` - Invitation tokens for new leaders
  
  2. Security
    - Enable RLS on new tables
    - Add policies for ADMIN/LEADER access control
    - Maintain existing people table RLS
  
  3. Triggers
    - Auto-update timestamps on leader_profiles
*/

-- LEADER PROFILES (extended data)
...
-- Allow public access to validate tokens (for invite acceptance)
